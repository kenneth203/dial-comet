-- Temporarily disable audit trigger for system updates
ALTER TABLE public.system_users DISABLE TRIGGER ALL;

-- Add christmas_closure_days field to system_users table
ALTER TABLE public.system_users 
ADD COLUMN IF NOT EXISTS christmas_closure_days numeric DEFAULT 5.0;
...
ALTER TABLE public.system_users ENABLE TRIGGER ALL;
