-- First, let's check what columns actually exist in comprehensive_users
-- and fix the RPC functions to match the actual schema

-- Update the get_all_basic_user_profiles function to only use existing columns
...
-- Update the get_basic_user_profile function for individual users
