-- Drop all existing versions of get_system_user_holiday_data function
DROP FUNCTION IF EXISTS get_system_user_holiday_data(uuid);
DROP FUNCTION IF EXISTS get_system_user_holiday_data(text);
