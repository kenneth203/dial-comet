-- Create missing functions for UserManagementContext
...
-- Fix the get_employee_basic_data_secure function to work without parameters when called from UserManagementContext
