-- Create a new version of get_holiday_admin_overview that handles duplicate user_ids properly
-- This works around the issue where all system_users share the same user_id
