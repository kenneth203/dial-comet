...
DROP FUNCTION IF EXISTS public.get_my_holiday_overview() CASCADE;
DROP FUNCTION IF EXISTS public.get_system_user_holiday_breakdown(uuid) CASCADE;
DROP FUNCTION IF EXISTS public.get_system_user_holiday_breakdown(uuid, integer) CASCADE;

-- Recreate the get_my_holiday_overview function cleanly
