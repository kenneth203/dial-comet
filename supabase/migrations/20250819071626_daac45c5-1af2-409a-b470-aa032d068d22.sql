...
-- Create audit trigger for financial data access
...
CREATE TRIGGER audit_financial_access
    AFTER SELECT OR INSERT OR UPDATE OR DELETE ON public.employee_financial_data
...
-- Create secure function to get financial data (HR/Super-Admin only)
