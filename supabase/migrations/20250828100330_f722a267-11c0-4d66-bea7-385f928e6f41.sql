-- Fix the staff data access audit function to handle NULL employee_user_id properly
-- for bulk access operations

-- First, let's make employee_user_id nullable for bulk access operations
ALTER TABLE public.staff_data_access_audit 
ALTER COLUMN employee_user_id DROP NOT NULL;

-- Update the get_staff_data_secure_with_audit function to handle bulk access properly
