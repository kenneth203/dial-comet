...
-- Create a new restricted policy that only shows basic fields
...
-- 4. Enhanced holiday request validation with proper security checks
...
-- 5. Add trigger to log all sensitive data modifications
