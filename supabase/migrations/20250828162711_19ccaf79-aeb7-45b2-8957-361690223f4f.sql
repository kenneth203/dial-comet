-- Drop and recreate the get_assignable_users function to return all user fields including holiday entitlements
...
AS $function$
  SELECT 
    ...
    system_users.hourly_rate,
    system_users.overtime_rate
