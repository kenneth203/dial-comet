...
-- Fix 5: Add audit log entry for this security hardening
INSERT INTO public.staff_data_access_audit (
  accessed_by, employee_user_id, data_type, access_reason, risk_score, fields_accessed
) VALUES (
  auth.uid(), null, 'SECURITY_HARDENING', 
  'Applied critical security fixes: locked down system_users, restricted shift_templates, added emergency access controls', 
  0, ARRAY['policy_updates', 'access_restrictions']
);