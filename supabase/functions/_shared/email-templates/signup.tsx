...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Welcome to The VA Team Portal</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img
          src="https://id-preview--8b31b9e2-c03e-432c-8f58-7a093ded151c.lovable.app/lovable-uploads/76e4bdc1-d3c0-4e93-bfc3-91c7c00ad781.png"
          alt="The VA Team"
          height="40"
          style={logo}
        />
        <Heading style={h1}>Welcome to The VA Team</Heading>
        <Text style={text}>
...
const link = { color: '#b73235', textDecoration: 'underline' }
